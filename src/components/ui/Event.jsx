...
const Event = ({ event_id, title, genre, image, cast = [], description = '', duration = '', releaseDate = '' }) => {
...
>
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
    <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-scroll p-6 relative scrollbar-hide">
      ...
      <button
        ...
        onClick={() => navigate(`/theaterPage/${title}`)}
      >
        Book Ticket
      </button>
    </div>
